...
router.post('/doDeleteAssetAlias', updatePostHandler, handler_doDeleteAssetAlias);
...
router.post('/doAddAssetGroupMember', updatePostHandler, handler_doAddAssetGroupMember);
router.post('/doDeleteAssetGroupMember', updatePostHandler, handler_doDeleteAssetGroupMember);
